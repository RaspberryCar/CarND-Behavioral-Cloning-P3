...
Please see [outdated instruction](playground/installTensorflow-firstAndOld-Jetson-way.sh) or better use [Jetson Ubuntu 20.04 image](https://github.com/Qengineering/Jetson-Nano-Ubuntu-20-image)
